...
class MemcachedProviderTest extends WebTestCase {
	...
	public function provideConvertMemcachedOption() {
		return [
			...
			[ 'libketama_compatible', \Memcached::OPT_LIBKETAMA_COMPATIBLE ], [ 'hash_with_prefix_key'  , \Memcached::OPT_HASH_WITH_PREFIX_KEY   ],
			...
			[ 'no_block'            , \Memcached::OPT_NO_BLOCK             ], [ 'use_udp'               , \Memcached::OPT_USE_UDP                ],
